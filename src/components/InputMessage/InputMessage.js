...
function InputMessage() {
	...
	return (
		<div className="w-full">
			...
			/>
			<div>
				<p className="my-4 text-lg font-bold text-neutral">Stripped Lowercase Message</p>
			...
			<div>
				...
				<div className="flex flex-wrap gap-0">{inputMessage.length >= 0 && renderedAurebesh}</div>
			</div>
		</div>
	);
}
